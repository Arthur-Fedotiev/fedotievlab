...
export default component$(() => (
  <section class="mb-32 text-gray-800">
    <div
      ...
      style="background-position: 50%; background-image: url('https://pbs.twimg.com/media/E4lUUTEVgAEjT_O?format=jpg&name=medium'); height: 500px;"
    ></div>
    <div class="container text-gray-800 px-4 md:px-12">
      <div
        class="block rounded-lg shadow-lg py-10 md:py-12 px-2 md:px-6 bg-neutral-800"
        style="margin-top: -200px; backdrop-filter: blur(30px);"
      >
        <div class="flex flex-wrap ">
          <div class="grow-0 shrink-0 basis-auto w-full xl:w-5/12 px-3 lg:px-6 mb-12 xl:mb-0 ">
            <form action="mailto:artur.fedotiew@gmail.com">
          ...
          <div class="grow-0 shrink-0 basis-auto w-full xl:w-7/12">
            <div class="flex justify-center items-center flex-wrap space-x-2">
              ...
              <a
                href="https://telegram.me/Arthur_Fedotiev"
                target="_blank"
                class="inline-block px-6 py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out"
